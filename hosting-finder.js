(function () {
  ...
  function render(options) {
    ...
    renderLinks(profile);
    updateUrl(answers);
    window.SHELLZ_FINDER_RESULT = { profileKey: resultData.best.key, secondKey: resultData.second.key, answers: answers, scores: resultData.ranking };
    document.dispatchEvent(new CustomEvent('shellz:finder-result', { detail: window.SHELLZ_FINDER_RESULT }));
